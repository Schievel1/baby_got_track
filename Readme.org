...
It uses a RaspberryPi RP2040 as this MCU gives a good mix of power, availabitly and reliability
Features:
- Trackball (duh)
- Per key RGB LED
- Uses a flexible PCB I made
- LED dotmatrix screens
- Roller encoders
...
- [[#about-this-repository][About this Repository]]
  - [[#change-later-when-images-are-gone-license][(change later when images are gone) License]]
- [[#building-guide][Building guide]]
  ...
  - [[#wiring--mounting][Wiring & Mounting]]
    ...
    - [[#if-you-have-the-blank-pcb-solder-the-diodes-and-leds-on][(if you have the blank PCB) Solder the diodes and LEDs on.]]
...
The idea and all some models come from Reddit user [[https://www.reddit.com/user/qqurn/][u/qqurn]]. Check out his Gitlab repository [[https://gitlab.com/keyboards1][here.]]
...
It was all way too much stuff crammed into that small housing and it I could actually guide people to doing botchery. I figured that the problem here was that everything is wired together using single wires and glued in place. (The RGB LEDs mainly.)
We need a circuit board!

TODO (remove this disclaimer) THE BOARD NEEDS TO BE TESTED AND CAN NOT BE BOUGHT YET
I therefore designed one and let it made. Anyone interested can buy it on ebay. They even come with RGB LEDS and diodes preinstalled for people who aren't keen on SMD soldering.

** TODO (change later when images are gone) License
...
*** Parts
- 3D printed case. A few models can be found in the folder [[./models][models]], but most 5x6 Tracktyl Models should work with the flexible PCB. You can also create new ones using [[https://github.com/bullwinkle3000/dactyl-keyboard][this generator]] or you can buy them directly from their [[https://wylderbuilds.com/][shop]]. Also [[https://github.com/Harry-the-Pott][a friend of mine]] sometimes print and sells them if he is in the mood.
...
- 2 flexible PCBs
- 10 Amoeba Kings
- (only if you have the blank PCB) 62 1N4148 Diodes in SOD-123 form. E.g. [[https://de.aliexpress.com/item/1005002383505485.html?spm=a2g0o.order_list.order_list_main.50.559e5c5fTMDYmt&gatewayAdapt=glo2deu][those.]] (definitely buy some extra of those, they break easily when hand soldered)
- (only if you have the blank PCB) 64 SK6803 MINI-E RGB LEDs. E.g.[[https://de.aliexpress.com/item/1005003636607308.html?spm=a2g0o.order_list.order_list_main.83.559e5c5fTMDYmt&gatewayAdapt=glo2deu][those.]] (people report they also easily break from heat while soldering, but none ever broke for me)
- 1 USB-C to USB-A cable. Or USB-C to USB-C. Or however you want to connect the keyboard to your computer.
- 2 RaspberryPi Pico RP2040 or clones of them with. E.g. [[https://de.aliexpress.com/item/1005003928558306.html][those.]] To fit them with the USB-C female to male cables (up next) make sure to get some in with USB-C connector.
...
- [[https://www.ebay.de/itm/275315539359?hash=item401a15bd9f:g:r7EAAOSwJIZhYdp6][1 PMW3360 Motion Sensor.]]
...
- solder, it depends on personal preference, but I used solder with 1mm diameter (Also for SMD, I don't mind) Don't be chear an solder, often enough a successfull solder job depends mostly on proper solder.
...
*** TODO (if you have the blank PCB) Solder the diodes and LEDs on.
The T4 housing usually has a thin line, this is the cathode. The line must be on the side the diode symbol on the PCB is pointing to.
...
*** TODO Solder the Amoeba kings

*** TODO Solder the pin headers onto the PCBs and the RP2040

*** TODO Solder the switches to the PCB

*** TODO Solder the roller encoders

*** TODO Solder the jumper wires between the TRRS socket and the RP2040.
...
When you are done, connect the wires to the RP2040.
...
After that connect the wires to the RP2040. Some RP2040 derivatives are not delivered with pin strips soldered to the board. (but they usually come with a pin strip alongside) If so, solder the pins strips to the RP2040 is a similar way you soldered the cables to the PMW3360.
